#include <inttypes.h>
//#include <avr/pgmspace.h> // Потом расскоментировать, нужна на микроконтроллере.
...
#define PROGMEM // УДАЛИТЬ ПРИ ПЕРЕНОСЕ НА ПЛАТУ!!!
static uint8_t SystemRus[] PROGMEM = { //static uint8_t SystemRus[] PROGMEM = 
